Feature: AI player acts in the start of game phase of an Magic: the Gathering game
    ...
    Scenario: [CR 103.2b] the AI player reveals a companion
        ...
        When the system asks the AI player for start of game decesions
        Then the AI Player marks the card as companion

    Scenario: the AI player reveals Chancellor of Dross
        Given the AI player has one Chancellor of Dross in hand
        When the system asks the AI player for start of game decesions
        Then the AI player registers a delayed trigger for Chancellor of Dross

    Scenario: the AI player reveals three Chancellor of Dross
        Given the AI player has three Chancellor of Dross in hand
        When the system asks the AI player for start of game decesions
        Then the AI player registers three different delayed trigger for each of the Chancellor of Dross
    ...
    Scenario: the AI player puts one Leyline on the battlefield
        ...
        When the system asks the AI player for start of game decesions
        Then the AI player puts one Leyline of the Guildpact on the battlefield
