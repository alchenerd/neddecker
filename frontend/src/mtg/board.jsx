...
export function Board({boardData, ned, setNed, user, setUser, cardImageMap, setSelectedCard, setDndMsg, setDblClkMsg, setWhoRequestShuffle, setActionTargetCard, setOpenMoveDialog, ...props}) {
